...
#define TEST_ADXL362_CS SPI_0_PIN_CS
#define TEST_ADXL362_SPI SPI_0

#define ADXL_INT1_PIN 18
...
int main(void)
{
    ...
    gpio_init(ADXL_INT1_PIN, GPIO_IN);
    ...
    while (1) {
    	...
    	sts = adxl362_status(&dev);
    	printf("%x - %x\n", sts, adxl362_reg(&dev, 0x27));
