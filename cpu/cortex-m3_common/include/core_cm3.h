...
#define MPU               ((MPU_Type       *)     MPU_BASE      )   /*!< Memory Protection Unit             */
    ...
    */
     ...
     */
    static __INLINE uint32_t NVIC_EncodePriority(uint32_t PriorityGroup, uint32_t PreemptPriority,
    ...
    static __INLINE uint32_t SysTick_Config(uint32_t ticks)
    {
        ...
        NVIC_SetPriority(SysTick_IRQn,
                         (1 << __NVIC_PRIO_BITS) - 1); /* set Priority for Cortex-M0 System Interrupts */
