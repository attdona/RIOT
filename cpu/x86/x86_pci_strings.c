    ...
    switch (baseclass) {
        ...
        case 0x01:
            *baseclass_name = "Mass storage controller";
            ...
            switch (subclass) {
                ...
                case 0x06:
                    return "Serial ATA Direct Port Access";
            ...
            switch (subclass) {
                case 0x00:
                    switch (interface) {
                        ...
                        default:
                            return "[UNDEFINED IN ACPI 3.0]";
                    }

                case 0x01:
                    return "XGA coltroller";
            ...
            switch (subclass) {
                ...
                case 0x01:
                    switch (interface) {
                        ...
                        case 0x03:
                            return "IEEE1284 controller";

                        case 0xef:
                            return "IEEE1284 target device";
                    }
                ...
                case 0x04:
                    return "GPIB (IEEE 488.1/2) controller";
            ...
            switch (subclass) {
                case 0x00:
                    switch (interface) {
                        ...
                        case 0x10:
                            return "I/O APIC interrupt controller (see below)";
                ...
                case 0x02:
                    switch (interface) {
                        ...
                        case 0x02:
                            return "EISA system timers (two timers)";
                    }
            ...
            switch (subclass) {
                case 0x00:
                    switch (interface) {
                        ...
                        case 0x01:
                            return "IEEE 1394 following the 1394 OpenHCI specification";
                    }
                ...
                case 0x03:
                    switch (interface) {
                        case 0x00:
                            return "Universal Serial Bus (USB) following the Universal Host Controller Specification";

                        case 0x10:
                            return "Universal Serial Bus (USB) following the Open Host Controller Specification";

                        case 0x20:
                            return "USB2 host controller following the Intel Enhanced Host Controller Interface";

                        case 0x80:
                            return "Universal Serial Bus with no specific programming interface";
        ...
        case 0x0d:
            *baseclass_name = "Wireless controller";
            ...
            switch (subclass) {
                ...
                case 0x20:
                    return "Ethernet (802.11a)";

                case 0x21:
                    return "Ethernet (802.11b)";

                case 0x80:
                    return "Other type of wireless controller";
            }
            ...
            *baseclass_name = "Intelligent I/O controller";
            ...
            switch (subclass) {
                case 0x00:
                    switch (interface) {
                        case 0x00:
                            return "Message FIFO at offset 040h";

                        default:
                            return "Intelligent I/O (I2O) Architecture Specification 1.0";
                    }
        ...
        case 0x10:
            *baseclass_name = "Encryption/Decryption controller";
            ...
            switch (subclass) {
                case 0x00:
                    return "Network and computing en/decryption";

                case 0x10:
                    return "Entertainment en/decryption";

                case 0x80:
                    return "Other en/decryption";
            }
        ...
        case 0x11:
            *baseclass_name = "Data acquisition and signal processing controller";
            ...
            switch (subclass) {
                ...
                case 0x10:
                    return "Communications synchronization plus time and frequency test/measurement";

                case 0x20:
                    return "Management card";

                case 0x80:
                    return "Other data acquisition/signal processing controllers";
            }
        ...
        case 0x8086:
            *vendor_name = "Intel Corporation";
            ...
            switch (device_id) {
                ...
                case 0x2668:
                    return "82801FB/FBM/FR/FW/FRW (ICH6 Family) HDA Controller";
                ...
                case 0x11C3:
                    return "PCIe* Root Port 0";

                case 0x11C4:
                    return "PCIe* Root Port 1";

                case 0x08A7:
                    return "SDIO / eMMC Controller";
                ...
                case 0x093A:
                    return "USB OHCI Host Controller";

                case 0x0937:
                    return "10/100 Ethernet";

                case 0x0935:
                    return "SPI Controller";

                case 0x0934:
                    return "I2C* Controller and GPIO Controller";
            }
